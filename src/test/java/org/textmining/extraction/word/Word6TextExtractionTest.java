...
public class Word6TextExtractionTest extends WordExtractionTestCase {

  @Test
  public void testSimple() throws IOException, PasswordProtectedException {
    textExtractionTest("org/textmining/extraction/word/winword6/simple.doc",
  ...
  public void testFastSaved() throws IOException, PasswordProtectedException {
    textExtractionTest("org/textmining/extraction/word/winword6/fastSaved.doc",
  ...
  public void testWithDeletedChanges()
    ...
    textExtractionTest("org/textmining/extraction/word/winword6/revisions.doc",
                       "This is a simple test of text extraction for Word documents.");
  }

  @Test
  public void testFieldCodes() throws IOException, PasswordProtectedException {
    textExtractionTest("org/textmining/extraction/word/winword6/fieldCode.doc",
                       "This is a simple test of text extraction for Word documents. The page number is 1.");
  }
